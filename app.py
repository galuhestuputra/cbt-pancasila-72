...
soal_cbt = [
    ...
    },
    {
        ...
        "pertanyaan": "Agama resmi yang diakui keberadaannya di Indonesia meliputi Islam, Kristen, Katolik, Hindu, Buddha, dan... [cite: 1294]",
    ...
    },
    {
        ...
        "pertanyaan": "Batas wilayah laut yang diukur mulai dari garis pangkal kepulauan Indonesia sampai dengan 12 mil laut ke arah laut lepas disebut... [cite: 224]",
    ...
    },
    {
        ...
        "pertanyaan": "Berdasarkan data sensus, suku bangsa dengan populasi terbanyak di Indonesia yang penyebarannya mencapai lebih dari 40 persen adalah... [cite: 1207]",
    ...
    },
    {
        ...
        "pertanyaan": "Tempat ibadah yang digunakan oleh umat Buddha di Indonesia adalah... [cite: 1279, 1305]",
        "opsi": ["A. Pura", "B. Wihara", "C. Klenteng", "D. Gereja"],
        "jawaban": "B. Wihara"
    },
    {
        "id": 10, "level": "L1", "kategori": "Bab 5", "image": None,
        "pertanyaan": "Bentuk Negara Kesatuan Republik Indonesia secara yuridis ditegaskan dan tidak dapat dilakukan perubahan, hal ini diatur dalam UUD NRI Tahun 1945 pasal... [cite: 342]",
    ...
    },
    {
        ...
        "pertanyaan": "Penduduk ras Melanesoid di Indonesia banyak mendiami wilayah bagian timur, di antaranya meliputi daerah... [cite: 1329]",
    ...
    },
    {
        ...
        "pertanyaan": "Wilayah selatan Indonesia berupa Laut Indonesia dan Laut Arafuru secara langsung berbatasan dengan negara... [cite: 164]",
    ...
    },
    {
        ...
        "pertanyaan": "Negara kesatuan di mana semua urusan dan peraturan daerahnya dikendalikan sepenuhnya oleh pemerintah pusat dinamakan bersistem... [cite: 331]",
    ...
    },
    {
        ...
        "pertanyaan": "Luas Zona Ekonomi Eksklusif (ZEE) Indonesia ditarik dari garis pangkal laut sejauh... [cite: 232]",
        "opsi": ["A. 12 mil", "B. 24 mil", "C. 200 mil", "D. 350 mil"],
        "jawaban": "C. 200 mil"
    },
    {
        "id": 17, "level": "L1", "kategori": "Bab 4", "image": None,
        "pertanyaan": "Makanan khas tradisional suku Minangkabau yang sangat terkenal adalah... [cite: 1243]",
        "opsi": ["A. Rendang", "B. Colenak", "C. Rawon", "D. Ayam Betutu"],
        "jawaban": "A. Rendang"
    },
    {
        "id": 18, "level": "L1", "kategori": "Bab 5", "image": None,
        "pertanyaan": "Bentuk negara serikat (federal) di Indonesia pernah diterapkan pada tahun 1949 melalui Republik Indonesia Serikat (RIS) sebagai hasil dari... [cite: 348]",
    ...
    },
    {
        ...
        "pertanyaan": "Sikap etnosentrisme merupakan ancaman bagi persatuan nasional karena sikap ini berarti... [cite: 403]",
    ...
    },
    {
        ...
        "pertanyaan": "Berdasarkan peraturan yang berlaku, batas ketinggian ruang udara wilayah kedaulatan Indonesia yang diukur dari permukaan daratan dan perairan adalah... [cite: 246]",
    ...
    },
    {
        ...
        "pertanyaan": "Sikap mementingkan suku sendiri secara berlebihan dan menganggapnya lebih unggul daripada suku lain dinamakan... [cite: 401]",
        "opsi": ["A. Sukuisme", "B. Individualisme", "C. Nasionalisme", "D. Patriotisme"],
        "jawaban": "A. Sukuisme"
    },
    {
        "id": 23, "level": "L1", "kategori": "Bab 4", "image": None,
        "pertanyaan": "Pakaian daerah bernama 'Ulee Balang' merupakan identitas budaya dari daerah... [cite: 1243]",
        "opsi": ["A. Sumatra Utara", "B. Jawa Barat", "C. Aceh", "D. Bali"],
        "jawaban": "C. Aceh"
    },
    {
        "id": 24, "level": "L1", "kategori": "Bab 5", "image": None,
        "pertanyaan": "Wilayah timur Indonesia, tepatnya di Pulau Papua, berbatasan daratan secara langsung dengan negara... [cite: 165]",
        "opsi": ["A. Australia", "B. Filipina", "C. Papua Nugini", "D. Timor Leste"],
        "jawaban": "C. Papua Nugini"
    },
    {
        "id": 25, "level": "L1", "kategori": "Bab 4", "image": None,
        "pertanyaan": "Agama yang menjadikan 'Weda' sebagai kitab suci utamanya adalah agama... [cite: 1305]",
    ...
    },
    {
        ...
        "pertanyaan": "Sebuah kapal penangkap ikan dari negara Z ditangkap patroli TNI AL karena terbukti mencari ikan di perairan sejauh 150 mil dari garis pantai Indonesia. Kapal tersebut ditangkap karena melanggar batas perairan... [cite: 232]",
    ...
    },
    {
        ...
        "pertanyaan": "Pemerintah daerah Kota Ambon saat ini memiliki wewenang untuk mengatur urusan rumah tangganya sendiri dan membangun fasilitas publik dari anggaran daerahnya. Ini menunjukkan negara Indonesia menerapkan sistem... [cite: 333]",
    ...
    },
    {
        ...
        "pertanyaan": "Memiliki kebanggaan terhadap negara itu penting, tetapi jika perasaan cinta tanah air tersebut diwujudkan secara berlebihan hingga merendahkan negara lain, maka hal ini disebut sebagai... [cite: 412]",
    ...
    },
    {
        ...
        "pertanyaan": "Berbeda dengan negara bagian di sistem serikat, provinsi di Indonesia berkedudukan di bawah pemerintah pusat dan harus mengacu pada satu konstitusi utama, yakni... [cite: 322, 329]",
    ...
    },
    {
        ...
        "pertanyaan": "Undang-Undang Nomor 43 Tahun 2008 memandang wilayah NKRI—baik darat, laut, maupun udara—sebagai satu kesatuan utuh. Jika suatu saat terjadi penemuan tambang mineral berharga di perairan kepulauan (archipelagic waters), maka secara yuridis hak kepemilikannya berada di tangan... [cite: 127]",
        "opsi": [
...
def proses_kirim_jawaban():
    try:
        with st.spinner("Sistem sedang mengamankan data ujian..."):
            time.sleep(1.5)  # Simulasi proses sinkronisasi server
...
def halaman_login():
    ...
    with col2:
        with st.form("form_login"):
            ...
            input_nama = st.text_input("Nama Lengkap", placeholder="Masukkan nama Anda di sini")
            ...
            if tombol_masuk:
                if not input_nama.strip() or input_kelas == "Pilih Kelas" or input_absen == "Pilih Absen" or not input_sekolah.strip():
                    st.error("Silakan lengkapi seluruh isian form login terlebih dahulu!")
                else:
                    st.session_state.user_data = {
...
def halaman_ujian():
    ...
    st.markdown("### Daftar Soal Ujian (50 Butir)")
    st.info("Pilihlah satu jawaban yang paling tepat. Anda dapat mengulas kembali jawaban Anda sebelum mengumpulkan tugas.")
    ...
    for i, q in enumerate(soal_cbt):
        ...
        # Penanganan index untuk radio button agar lebih aman (fallback mode)
        jawaban_saat_ini = st.session_state.jawaban_user.get(q["id"])
        idx_opsi = None
        if jawaban_saat_ini in q["opsi"]:
            idx_opsi = q["opsi"].index(jawaban_saat_ini)
    ...
    # Tombol Pengumpulan Jawaban
    if st.session_state.submit_status == "Berhasil":
        st.success("✔ UJIAN SELESAI! Data berhasil terkirim ke *database* pusat. Silakan tekan tombol di bawah untuk keluar.")
        if st.button("Keluar & Kembali ke Login"):
            st.session_state.logged_in = False
            st.session_state.user_data = {}
            st.session_state.jawaban_user = {q["id"]: None for q in soal_cbt}
            st.session_state.submit_status = None
        ...
        st.error("✖ PENGIRIMAN GAGAL! Periksa koneksi internet Anda. Silakan coba kirim ulang.")
        if st.button("Kirim Ulang Jawaban", type="primary"):
            proses_kirim_jawaban()
            st.rerun()
            
    else:
        st.warning("Perhatian: Pastikan seluruh soal telah Anda jawab.")
        if st.button("KUMPULKAN JAWABAN", type="primary", use_container_width=True):
            proses_kirim_jawaban()
            st.rerun()

def halaman_guru():
    st.markdown("### 🔐 Dashboard Guru (Rekapitulasi Nilai)")
    st.info("Halaman ini berfungsi sebagai simulasi *database* penyimpan nilai dari sesi aplikasi berjalan.")
    ...
    if not df_data.empty:
        ...
        with pd.ExcelWriter(memori_excel, engine="openpyxl") as penulis:
            df_data.to_excel(penulis, index=False, sheet_name="Data Nilai")
            
        st.download_button(
            label="📥 Download Format Excel (.xlsx)",
            data=memori_excel.getvalue(),
            file_name=f"Nilai_CBT_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx",
            mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
            type="primary"
        )
    else:
        st.warning("Belum ada respons ujian yang masuk dari siswa.")

# ==========================================
# RUTING UTAMA
# ==========================================
def main():
    tab_peserta, tab_guru = st.tabs(["💻 Ujian CBT", "📝 Panel Guru"])
    ...
    st.markdown(f"""
        <div style='text-align: center; color: #888; font-size: 0.9em; border-top: 1px solid #ccc; padding-top: 15px;'>
            <strong>Hak Cipta &copy; 2026 - Aplikasi Penilaian CBT</strong><br>
            Dikembangkan oleh: {APP_AUTHOR} | {APP_SCHOOL}<br>
            Kontak: {APP_CONTACT}
        </div>
